...
import { UpdateEventRequest, Event, EventType, EventData, isFullEventResponse } from '../../../../core/events/types/event';
...
export default function EditEventScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await eventService.updateEvent(eventId, { event: updates });
