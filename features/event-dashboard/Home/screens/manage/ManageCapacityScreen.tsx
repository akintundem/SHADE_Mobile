...
import { isFullEventResponse, Event } from '../../../../../core/events/types/event';
  ...
  const handleSaveChanges = useCallback(async () => {
    ...
    try {
      ...
      if (registrationStatus !== originalRegistrationStatus) {
        await eventService.updateRegistrationState(
          params.eventId,
      ...
      if (Object.keys(updates).length > 0) {
        await eventService.updateEvent(params.eventId, { event: updates });
      }
